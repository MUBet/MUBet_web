...
web3.version.getNetwork((err, netId) => {
  ...
  switch (netId) {
    case "1":
      ...
      instance = contract.at("0x517be460E08A7EcCe448f54B41658c0BfB0d8674"); // Put the main Ethereum network contract address here
      break
    case "2":
      document.getElementById("tests").innerHTML ='This is the Morden test network, MUBet is currently not deployed here. Please switch to the Ropsten Network using Metamask for testing purposes.<br>';
      break
    case "3":
      document.getElementById("tests").innerHTML ='You are using the Ropsten test network.<br>';
      instance = contract.at("0x517be460E08A7EcCe448f54B41658c0BfB0d8674");
      break
    default:
